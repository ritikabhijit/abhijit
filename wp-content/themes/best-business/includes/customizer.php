...
function best_business_customize_controls_register_scripts() {
	...
	wp_enqueue_style( 'best-business-customize-controls', get_template_directory_uri() . '/css/customize-controls' . $min . '.css', array(), '2.0.2' );
	wp_enqueue_script( 'best-business-customize-controls', get_template_directory_uri() . '/js/customize-controls' . $min . '.js', array( 'jquery', 'customize-controls' ), '2.0.2', true );
}
