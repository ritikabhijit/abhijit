...
if ( ! class_exists( 'Best_Business_Demo' ) ) {
	 ...
	 * @version 1.0.1
	 */
	class Best_Business_Demo {

		/**
		 * Singleton instance of Best_Business_Demo.
		 *
		 * @var Best_Business_Demo $instance Best_Business_Demo instance.
		 */
		...
		/**
		 * Main Best_Business_Demo instance.
		 *
		 * @since 1.0.0
		 *
		...
		public static function init( $config ) {
			if ( ! isset( self::$instance ) && ! ( self::$instance instanceof Best_Business_Demo ) ) {
				self::$instance = new Best_Business_Demo();
